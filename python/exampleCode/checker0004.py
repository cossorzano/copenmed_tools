...
<<<<<<< HEAD
                         464, # Substance should be avoided if Group is present
=======
...
<<<<<<< HEAD
                     (241,  # Group of treatments may cause Group of diseases
                      ...
                      77),  # Disease belongs to Group
                     (241,  # Group of treatments may cause Group of diseases
                      442,  # GroupOfTreartments should be avoided with GroupOfDiseases
                      76),  # Group1 is a subgroup of Group2
=======
>>>>>>> c79b8ea472b68ecb4fb2b58da2699dc3ca20083d
...
<<<<<<< HEAD
    ...
    def checkRelationsToPoblacionGeneral(self):
        ...
        PREVALENCE_CAUSE = 556
        PREVALENCE_SYMPTOM = 557
        PROBABILITY = 323
        IS_SUBGROUP = 200
        Ncount=0
        ...
        for idEntityFrom, idEdgeType, idEdge in nodeGeneral.incomingEdges:
            ok = idEdgeType==PREVALENCE_DISEASE or idEdgeType==PREVALENCE_GROUP or \
                 idEdgeType==PROBABILITY or idEdgeType==PREVALENCE_SYMPTOM or \
                 idEdgeType==PREVALENCE_CAUSE
    ...
    def checkHighPrevalences(self):
        ...
        whiteList = [ (2158, 435), (18, 641), (125, 5441), (268, 641),
            ...
            (13932, 641), (14557, 641), (13656, 641), (521, 1707),
            (7359, 641), (13701, 641), (14561, 438), (14668, 641),
            (14827, 641), (14821, 641), (15247, 15259), (15381, 3273),
            (15383, 3273), (15685, 641), (15692, 641), (15693, 641)
            ]
    ...
    def checkMultipleRelationships(self):
        ...
        for idEntity in range(self.graph.getNodeMax()):
            ...
            for idEntityTo, idEdgeType, idEdge in node.outgoingEdges:
                if idEntityTo==CIE11: # Skip those relationships to CIE11
                    continue
                if not idEntityTo in self.entity_dict:
                    continue
                if idEdgeType in whiteList:
                    continue
...
<<<<<<< HEAD
    ...
    def checkEnglish(self):
        language_dict = {}
        for idEntity in self.entity_dict:
            _, _, _, language = self.entity_dict[idEntity]
            if idEntity in language_dict:
                if language_dict[idEntity]==0:
                    if language=="English" or language=="All":
                        language_dict[idEntity]=1
            else:
                language_dict[idEntity]=1 if language=="English" else 0

        for idEntity in self.details_dict:
            for row in self.details_dict[idEntity].itertuples():
                language = row.Idioma
                if language_dict[idEntity]==0:
                    if language=="English" or language=="All":
                        language_dict[idEntity]=1

        print("Entidades sin nombres en ingles: =================")
        toPrint=""
        Ncount=0
        for idEntity in language_dict:
            if language_dict[idEntity]==0:
                toPrint+="%d, "%idEntity
                Ncount+=1
        print(toPrint)
        print("Numero de entidades sin ingles: %d"%Ncount)
